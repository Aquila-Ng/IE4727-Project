<?php
    ...
    function cart_row($cartId, $name, $price, $variantId, $quantity, $maxQuantity, $image, $variantName) {
        ...
        <tr data-cartId="<?php echo htmlspecialchars($cartId); ?>">
            ...
            <td class="hug-column">
                <form class="p-0" id="cartQuantityChange-<?php echo htmlspecialchars($variantId); ?>" action="../includes/scripts/cart_changes.php" method="GET">
            ...
            <td class="hug-column">
                <div class="mt-3">
                    <a href="../includes/scripts/cart_changes.php?variantId=<?php echo htmlspecialchars($variantId); ?>&quantity=0">
