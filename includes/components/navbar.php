                                      ...
                                      <div class="dropdown-content">
                                          <?php if ($isLoggedIn) { ?>
                                            <a href="profile.php" class="item">
                                              ...
                                              <h5 class="m-1">Profile Details</h5>
                                            </a>
                                            <a href="order-history.php" class="item">
                                              ...
                                              <h5 class="m-1">Order History</h5>
                                            </a>
                                            <a href="../includes/scripts/logout.php" class="item">
